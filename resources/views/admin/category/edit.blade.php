                ...
                <div class="widget-header">
                    <div class="row">
                        <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                            <h4>Edit {{ $editCategory->title }} Category</h4>
                        </div>
                    </div>
                </div>
                <div class="widget-content widget-content-area br-6">
                    <div class="row">
                        <div class="col-lg-12 col-12 mx-auto">
                            {!! Form::open(['url'=>route('admin.category.update'), 'enctype'=>'multipart/form-data']) !!}
                            <input type="hidden" name="category_id" value="{{$editCategory->id}}">
                            @include('admin.category.CommonFile.form')
...
<script>
    ...
    var importedBaseImage = "{{ asset($editCategory->image) }}"
