    ...
    <div class="layout-px-spacing">
        ...
        <div class="row layout-top-spacing">
            <div id="breadcrumbArrowed" class="col-xl-12 col-lg-12 layout-top-spacing mb-3">
                @include('admin.partials.breadcrumbs', ['type'=>'index', 'label'=>'Package', 'route'=>'package'])
            </div>
                    ...
                    <div class="table-responsive mb-4 mt-4">
                        <table id="zero-config" class="table table-hover" style="width:100%">
                            ...
                            <tr>
                                ...
                                <td class="text-left">
                                    <span><img src="{{ asset($package->image) }}" width="50" ></span>
                                </td>
                                <td> @if($package->status == "Active" ) <span class="badge badge-success">Active</span> @else <span class="badge badge-danger">Inactive</span> @endif</td>
                                <td> {{ $package->package_type }}</td>
                                <td>

                                    <a href="{{ route('admin.package.edit', $package->id) }}" title="Edit" class="badge badge-success"> <i data-feather="edit"></i></a>
                                    <a href="{{ route('admin.package.delete', $package->id) }}" title="Delete" class="badge badge-dark warning confirm"><i data-feather="archive"></i></a>
