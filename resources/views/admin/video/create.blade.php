    ...
    <div class="layout-px-spacing">
        ...
        <div class="row layout-top-spacing">
            <div id="breadcrumbArrowed" class="col-xl-12 col-lg-12 layout-top-spacing mb-3">
                @include('admin.partials.breadcrumbs', ['type'=>'create', 'label'=>'Video', 'route'=>'video'])
            </div>
                ...
                <div class="widget-content widget-content-area br-6">
                    <div class="row">
                        <div class="col-lg-12 col-12 mx-auto">
                            {!! Form::open(['url'=>route('admin.video.store'), 'enctype'=>'multipart/form-data']) !!}
...
<script>
    $(document).ready(function(){
        ...
        function jwplayerKey(videokey) {
            jwplayer('player').setup({
                playlist: 'https://cdn.jwplayer.com/v2/media/xYov8iQV' + videokey,
                autostart: true,
                floating: true,
                width: '640px',
                height: '360px'
